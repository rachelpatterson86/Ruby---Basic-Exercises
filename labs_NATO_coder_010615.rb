...
# Write your own NATO abc. There should be a function to encode and decode.
...
# letter form and return that. Non-abcical should be copied/stay the same in
# both cases.
...
# BONUS!
#
# See wikipedia page for ROT-13. Try to write an encoder and decoder for ROT-13.

@nato = %w(alfa bravo charlie delta echo foxtrot golf hotel india
